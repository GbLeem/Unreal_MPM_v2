...
#include "MPM3D_NeoHookean_legacy.h"

// Sets default values
AMPM3D_NeoHookean_legacy::AMPM3D_NeoHookean_legacy()
	:NumParticles(0)
{
...
void AMPM3D_NeoHookean_legacy::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AMPM3D_NeoHookean_legacy::Tick(float DeltaTime)
{
...
void AMPM3D_NeoHookean_legacy::ClearGrid()
{
	for (int i = 0; i < NumCells; ++i)
	{
		Cell* cell = m_pGrid[i];
...
void AMPM3D_NeoHookean_legacy::P2G()
{
	for (int i = 0; i < NumParticles; ++i)
	{
		Particle* p = m_pParticles[i];
...
void AMPM3D_NeoHookean_legacy::UpdateGrid()
{
	for (int i = 0; i < NumCells; ++i)
	{
		Cell* cell = m_pGrid[i];
...
void AMPM3D_NeoHookean_legacy::G2P()
{
	for (int i = 0; i < NumParticles; ++i)
	{
		Particle* p = m_pParticles[i];
...
void AMPM3D_NeoHookean_legacy::Simulate()
{
	ClearGrid();
	P2G();
	UpdateGrid();
...
void AMPM3D_NeoHookean_legacy::UpdateParticles()
{
	TArray<FTransform> Transforms;
